    ...
    <AnimatePages>
      <div className=" hidden mtab:block   w-screen max-w-[1440px]  mx-auto mt-[88px] pt-[32px]">
        ...
        {shoppingBagBooks.length === 0 && (
          <div className=" flex justify-center items-center translate-x-[-5%] text-bodyN tab:text-bodyL font-reg text-neutral-30     w-full  h-[80vh] mtab:pl-[72px] tab:pl-[86px] lap:pl-[193px]  desk:pl-[181px] mtab:pr-[24px] tab:pr-[50px]  lap:pr-[40px] desk:pr-[10px] overflow-hidden   ">
      ...
      <div className=" mtab:hidden   w-full min-h-screen mt-[68px] py-[17px] px-[23px] mobx:px-[60px]">
        ...
        {shoppingBagBooks.length === 0 && (
          <div className=" flex justify-center items-center translate-x-[-5%] text-bodyS  font-reg text-neutral-30     w-full  h-[50vh] px-[23px]  ">
            You have no item in your shopping bag
          </div>
        )}
