  ...
  return (
    <div className="w-full h-[86px] mt-[48px]">
      ...
      <input
        onChange={onChange}
        {...inputProps}
        className=" outline-none   w-[170px]  moby:w-[256px] h-[48px]   lap:h-[56px] mt-[12px] p-[15px] rounded-[4px] border-2 border-[#FFA599] text-bodyL text-neutral-80 active:ring-1 ring-[#FFA599]"
      />
      <div className="error">
