      ...
      <AnimatePresence>
        {(isError || isGoogleError || isSuccess) && (
          <motion.div
            ...
            className=" text-bodyS   mtab:text-bodyL  tab:text-h4 rounded-[4px] fixed z-50 top-[80px] right-[25px] text-neutral-white bg-primary-50   w-[100px] h-[40px] mtab:w-250px mtab:h-[70px]    tab:w-[400px] tab:h-[100px] flex justify-center items-center  p-[10px]"
          >
            {user?.message}
